...
/**
 * Premium Cream & Gold Wedding Invitation Theme
 * Names: Nethmi & Lahiru
 * Background: Cream
 * Accents: Gold
 */
...
function CountdownTimer() {
  const targetDate = new Date("August 14, 2026 09:00:00").getTime();
...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw4pWJqzeBgQrtimouZ0h5HeQO2H35j3X3rgNR3-Fl-0sIpt5ukb32cbDRfbgwft02uMg/exec";
...
function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-theme-50 flex items-center justify-center p-4 font-montserrat">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full space-y-6">
        <h1 className="text-2xl font-cinzel font-bold text-center text-theme-900">Link Generator</h1>
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest mb-2">Prefix</label>
            <select value={prefix} onChange={(e) => setPrefix(e.target.value)} className="w-full border-b border-theme-200 py-2 focus:outline-none focus:border-theme-500 bg-transparent">
          ...
          <div>
            <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest mb-2">Guest Name</label>
            <input type="text" placeholder="e.g. John Doe" value={name} onChange={(e) => setName(e.target.value)} className="w-full border-b border-theme-200 py-2 focus:outline-none focus:border-theme-500 bg-transparent" />
          </div>
          <button onClick={handleGenerate} className="w-full bg-theme-800 text-white py-3 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-theme-900 transition-colors">Generate Link</button>
        </div>
        {generatedLink && (
          <div className="mt-6 space-y-4 bg-theme-50 p-4 rounded-xl">
            <p className="text-xs text-stone-500 break-all">{generatedLink}</p>
            <button onClick={handleCopy} className="w-full border border-theme-300 text-theme-800 py-2 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-theme-100 transition-colors">Copy Link</button>
          </div>
        )}
      </div>
    </div>
          ...
          >
            ...
            <div className="absolute top-12 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
              <p className="font-cinzel text-[11px] tracking-[0.8em] font-bold uppercase flex flex-col items-center gap-3">
                <span className="bg-gradient-to-r from-yellow-400 via-yellow-200 to-yellow-500 bg-clip-text text-transparent opacity-80">N & L</span>
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                    ...
                    >
                      {hasGuest ? (
                        <div className="flex flex-col items-center space-y-2">
                          <span className="text-[10px] md:text-[13px] text-zinc-800 font-cinzel px-5 py-2">
                            We cordially invite
                          </span>
                          <span className="text-sm md:text-lg font-playball font-bold text-theme-800">
                  ...
                  >
                    ...
                    <div className="font-cinzel space-y-1">
                      <p className="text-sm md:text-base text-stone-700 tracking-[0.2em] md:tracking-[0.3em] font-bold">2023 අගෝස්තු මස 12</p>
                      <p className="text-[8px] md:text-[9px] text-theme-600 tracking-[0.2em] uppercase font-bold">විජයගිරි සංස්කෘතික පියස, අත්තනගල්ල</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                >
                  ...
                  <p className="text-zinc-800 text-[10px] md:text-[14px] tracking-[0.6em] md:tracking-[0.8em] uppercase font-bold text-center leading-relaxed max-w-2xl px-4">
                    <span className="text-theme-500 block text-[8px] md:text-[10px] mb-3 md:mb-4 tracking-[0.8em]">අතිනත ගැනීමේ ප්‍රීතිය නිමිත්තෙන්</span>
                    පැවැත්වෙන<br className="hidden md:block" />
                    <span className="text-theme-600">ප්‍රිය සම්භාෂණය</span>
                  </p>
                ...
                >
                  ...
                  <div className="relative drop-shadow-[0_20px_40px_rgba(75,85,99,0.25)]">
                    <InviteImage
                      src={brideGroomImage}
                      alt="Bride and groom wedding illustration"
                      loading="eager"
                      className="w-[220px] h-auto md:w-[300px] object-contain"
                    />
                  </div>
                </motion.div>
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center md:items-stretch gap-6 md:gap-10 my-12 md:my-20 z-10 px-2 lg:px-8">
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">පී. ජිනදාස මහතාගේ සහ<br />එච්.එම්. ප්‍රේමවතී මහත්මියගේ</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">නෙත්මි</h3>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        <p className="text-[7px] md:text-[8px] uppercase tracking-[0.4em] font-bold text-stone-400">ආදරණීය පුත්</p>
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">ඩබ්.එල්. කුමාරසිංහ මහතාගේ සහ<br />කේ.ඒ. මාලිනී මහත්මියගේ</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">ලහිරු</h3>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 text-center w-full max-w-4xl px-4">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">2023.08.12</p>
                      <p className="font-cinzel text-lg md:text-xl text-theme-600 tracking-[0.3em] font-normal mt-2">සෙනසුරාදා</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">ප.ව. 2.00</p>
                      <p className="font-cinzel text-xs md:text-sm text-theme-600 tracking-[0.2em] mt-3 uppercase">ප්‍රිය සම්භාෂණය</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="space-y-4 flex flex-col items-center">
                      <p className="text-[10px] md:text-[12px] uppercase tracking-[0.5em] text-stone-400 font-bold">අවස්ථාව</p>
                      <h4 className="font-cinzel text-2xl md:text-4xl text-theme-900 tracking-[0.3em] font-bold drop-shadow-sm px-4 text-center">ප්‍රිය සම්භාෂණය</h4>

                      <div className="flex items-center gap-6 mt-6">
                        <div className="w-12 md:w-20 h-[1.5px] bg-gradient-to-r from-transparent to-theme-300" />
                        <div className="flex flex-col items-center">
                          <p className="font-cinzel text-xl md:text-2xl text-theme-700 font-bold tracking-[0.2em]">ප.ව. 2.00</p>
                          <p className="text-[8px] md:text-[9px] uppercase tracking-[0.3em] text-theme-400 font-bold mt-1">සිට ප.ව. 5.00 දක්වා</p>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open('https://maps.app.goo.gl/TrBDk1JX6ZDgaz3g7?g_st=iw', '_blank')}
                  ...
                  >
                    ...
                    <div className="absolute inset-0 w-full h-full scale-[1.2] group-hover:scale-[1.15] transition-transform duration-[2s]">
                      <iframe
                        src="https://maps.google.com/maps?q=Paradise%20inn%20bolgoda&t=&z=14&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  ...
                  <p className="text-stone-300 text-sm md:text-base max-w-md mx-auto leading-relaxed mb-16 tracking-wide font-light">
                    මෙම ප්‍රිය සම්භාෂණයට සහභාගී වන මෙන් ආදරයෙන් ඇරයුම් කරනු ලැබේ.
                  </p>
            ...
            <div className="relative bg-[#FFFFFF]">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Nethmi & Lahiru</h3>
              ...
              <footer className="py-20 border-t border-theme-200/30 text-center relative z-10 space-y-6">
                <p className="text-[9px] md:text-[11px] uppercase tracking-[0.5em] text-stone-500 font-bold">
                  © 2026 Nethmi & Lahiru. All rights reserved.
                </p>

                <div className="flex flex-col items-center gap-2 pt-8">
                  <a
                    href="https://wa.me/94775722949"
                    target="_blank"
